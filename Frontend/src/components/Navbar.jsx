...
const Navbar = () => {
    ...
    return (
        <>
            <div className={`dark:bg-slate-900 dark:text-white bg-base-100 max-w-screen-2xl mx-auto container md:px-20 sm:p-4 sticky top-0 left-0 right-0 z-50 ${sticky ? "dark:bg-slate-600 dark:text-white sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""
                }`}>
                <div className="navbar">
                    ...
                    <div className="navbar-end">
                        ...
                        {authUser ? (<Logout />) : (<div>
                            <a className="bg-black text-white m-2 px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={() => document.getElementById("login_modal").showModal()}>Login</a>
                            <Login />
                        </div>)}
                    </div>
                </div>
